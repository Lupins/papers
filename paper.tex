...
The saliency map was chosen as a stream for its spatial relation to the frame, as the raw RGB frames are prone to environment interference, and its performance in the works of Yang et al.~\cite{yang2019.} and Sigal et al.~\cite{sigal
Sundararajan's et al.~\cite{sundararajan2017axiomatic} saliency method is used in this work.
